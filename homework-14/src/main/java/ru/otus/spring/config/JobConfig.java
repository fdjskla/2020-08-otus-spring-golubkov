...
public class JobConfig {
    ...
    public static final String PROCESS_PLAYERS_JOB_NAME = "processPlayersJob";
...
*/
    ...
    @StepScope
    @Bean
    public ItemProcessor processor(MigrationService migrationService) {
        return (ItemProcessor<Person, Person>) migrationService::doHappyBirthday;
    }
    ...
    public Job importUserJob(Step step1) {
        return jobBuilderFactory.get(PROCESS_PLAYERS_JOB_NAME)
